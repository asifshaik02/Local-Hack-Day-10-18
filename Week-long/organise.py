...
# if location is:  C:\Users\MOHAMMED ASIF\Downloads\Test
# Then the path variable should be: path = r'C:\Users\MOHAMMED ASIF\Downloads\Test'
...
path = r'C:\Users\MOHAMMED ASIF\Downloads\Test'
scan()
